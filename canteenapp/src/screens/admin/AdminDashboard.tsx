...
import { View, SafeAreaView, StatusBar, StyleSheet, Alert, Text } from 'react-native';
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <View style={styles.header}>
        <View style={styles.menuButton}>
          <Icon name="shield-account" size={28} color="#fff" />
        </View>
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Admin Panel</Text>
          <Text style={styles.headerSubtitle}>Manage everything efficiently</Text>
        </View>
