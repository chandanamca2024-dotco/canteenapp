    ...
    <ScrollView style={[styles.content, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        <View style={[styles.statCard, { backgroundColor: colors.surface }]}>
          <View style={[styles.statIconCircle, { backgroundColor: '#10B98120' }]}>
            <Icon name="currency-inr" size={24} color="#10B981" />
          </View>
        ...
        <View style={[styles.statCard, { backgroundColor: colors.surface }]}>
          <View style={[styles.statIconCircle, { backgroundColor: '#F59E0B20' }]}>
            <Icon name="clock-time-eight" size={24} color={colors.warning} />
          </View>
          <View style={styles.statInfo}>
      ...
      <View style={styles.quickActions}>
        ...
        <View style={styles.actionGrid}>
          {[
            { id: 'orders', label: 'Orders', iconName: 'file-document', color: '#8B5CF6' },
            { id: 'menu', label: 'Menu', iconName: 'silverware-fork-knife', color: '#10B981' },
            { id: 'addItems', label: 'Add Items', iconName: 'plus-circle', color: '#EC4899' },
            { id: 'sales', label: 'Sales', iconName: 'chart-line', color: '#F59E0B' },
            { id: 'users', label: 'Users', iconName: 'account-group', color: '#A78BFA' },
            { id: 'feedback', label: 'Feedback', iconName: 'star', color: '#F472B6' },
          ].map(action => (
            <TouchableOpacity 
              key={action.id} 
