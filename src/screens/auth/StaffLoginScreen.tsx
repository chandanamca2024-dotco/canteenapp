    ...
    >
      <View style={styles.card}>
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoTitle}>ℹ️ Staff Login</Text>
          <Text style={styles.infoText}>
            Only canteen staff members can access this area. If you don't have an account, please contact your administrator.
          </Text>
        </View>
      </View>
    </KeyboardAvoidingView>
